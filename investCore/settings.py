...
ALLOWED_HOSTS = ['localhost','127.0.0.1','65.0.202.177','3.6.145.120','concordeinvestments.in','www.concordeinvestments.in']
...
STATICFILES_DIRS = [ BASE_DIR / 'assets', '/var/www/assets', ]
...
EMAIL_RECEIVING_USER = ['support@neurosoftech.org','info@concordeinvestments.in'] # email on which you will receive messages sent from website